...
function renderSiteHeader(siteName, activeNav = "") {
  ...
  return `<header class="site-header">
    <a class="site-brand" href="/">
      <img src="/images/brand/huamei-logo.webp" alt="">
      <span>HM 华美服务中心</span>
    </a>
    <nav aria-label="主要导航">
      ${nav}
...
:root{--forest:#3A2E26;--bone:#F2EAD8;--bone-warm:#F8F1E2;--line:#ded4c4;--paper:#fffdf8;--paper-2:#f8f4ea;--sage:#6B7A5A;--sage-soft:#edf1e7;--gold:#a8813c;--gold-soft:#f8ecd6;--sky-soft:#f2ede1;--blue:#786440;--rose:#a4432e;--rose-soft:#f7e9e2}
