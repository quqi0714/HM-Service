...
.entry-page,.list-page{width:min(1120px,100%);margin:0 auto;padding:clamp(18px,4vw,52px)}.entry-article{background:var(--paper);border:1px solid var(--line);border-radius:18px;overflow:hidden;box-shadow:0 24px 70px -52px rgba(58,46,38,.6)}.entry-hero__media{margin:0;background:#fffaf1;display:grid;place-items:center;padding:16px 16px 10px}.entry-hero__media img{width:auto;max-width:100%;height:clamp(240px,38vh,360px);object-fit:contain;display:block;background:#fffaf1}.entry-hero__media figcaption{margin-top:10px;font-size:14px;font-weight:800;color:var(--muted)}.entry-hero__media a{text-decoration:none;border-bottom:1px solid currentColor}
