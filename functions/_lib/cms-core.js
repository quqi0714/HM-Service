...
*{box-sizing:border-box}html{background:var(--bone)}body{margin:0;overflow-x:hidden;background:linear-gradient(180deg,#f8f1e2 0%,var(--bone) 42%,#e8dcc5 100%);color:var(--ink);font-family:Inter,"Noto Sans SC",-apple-system,BlinkMacSystemFont,"PingFang SC",sans-serif;line-height:1.65}
...
.entry-card{background:var(--paper);border:1px solid var(--line);border-radius:14px;overflow:hidden}.entry-card a{display:grid;grid-template-columns:190px minmax(0,1fr);min-height:230px;text-decoration:none;height:100%}.entry-card__media{background:#fffaf1;border-right:1px solid var(--line);height:230px;display:flex;align-items:center;justify-content:center;overflow:hidden}.entry-card__media img{width:100%;height:100%;object-fit:contain;display:block}.entry-card__media.empty:before{content:"HM";color:var(--line);font-family:Marcellus,Georgia,serif;font-size:28px}.entry-card__body{display:grid;grid-template-columns:minmax(0,1fr) 150px;gap:18px;padding:18px 18px 16px;min-width:0}.entry-card__main{min-width:0;overflow:hidden}.entry-card h2{font-family:Marcellus,"Noto Serif SC",Georgia,serif;font-size:28px;font-weight:500;line-height:1.18;margin:10px 0 12px;max-width:700px;overflow-wrap:anywhere}.entry-card p{color:var(--muted);margin:0 0 12px}.entry-card__facts{display:grid;grid-template-columns:repeat(3,minmax(96px,1fr));gap:8px;margin:0;padding:0;max-width:620px}.entry-card__facts div{border-top:1px solid var(--line);padding-top:8px}.entry-card__facts dt{color:var(--muted);font-size:12px}.entry-card__facts dd{margin:2px 0 0;font-size:15px;font-weight:800}.entry-card__aside{display:flex;flex-direction:column;align-items:flex-end;justify-content:space-between;gap:12px}.entry-card__date{border:1px solid var(--line);border-radius:999px;background:#fffaf1;color:var(--ink);font-size:13px;font-weight:800;line-height:1;padding:5px 10px;white-space:nowrap}.entry-card__cta{color:var(--forest);font-size:14px;font-weight:800;border-bottom:1px solid currentColor}
